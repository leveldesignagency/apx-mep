...
export default function LandingPage() {
  ...
  return (
    <div className="h-screen text-white flex flex-col overflow-hidden relative z-10 bg-black">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-12 mb-12 text-center">
          <a href="tel:+441234567890" className="group hover:scale-105 transition-transform duration-300 cursor-pointer" title="+44 (0) 1234 567890">
            <Phone className="h-8 w-8 text-white group-hover:text-gray-300 transition-colors" />
          </a>
          <a href="mailto:info@apx-mep.co.uk" className="group hover:scale-105 transition-transform duration-300 cursor-pointer" title="info@apx-mep.co.uk">
            <Mail className="h-8 w-8 text-white group-hover:text-gray-300 transition-colors" />
          </a>
          <a href="https://maps.google.com/?q=365-369+Bexley+Road+Northumberland+Heath+Erith,+Kent,+DA8+3EZ" target="_blank" rel="noopener noreferrer" className="group hover:scale-105 transition-transform duration-300 cursor-pointer" title="365-369 Bexley Road Northumberland Heath Erith, Kent, DA8 3EZ">
      ...
      <div className="absolute right-8 top-1/2 transform -translate-y-1/2 flex flex-col gap-6">
        ...
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-300 transition-colors">
          <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069z"/></svg>
        </a>
