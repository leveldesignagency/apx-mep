    ...
    <div className="about-parallax-page overflow-x-hidden snap-y snap-mandatory">
        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <p className="text-lg text-black/80 leading-relaxed mb-6">
              Our team of fully qualified professionals are certified in MEP systems, with regular training
              programmes and deep industry expertise to deliver projects to the highest standards.
            </p>
            <ul className="space-y-2 text-black/90">
              <li>• Fully qualified professionals</li>
              <li>• Certified in MEP systems</li>
              <li>• Regular training programmes</li>
            </ul>
          </div>
      ...
      <section className="about-block about-block--black about-block--angle-top min-h-screen flex flex-col justify-center px-0 py-24 snap-start">
        <div className="px-6 lg:px-12 mb-10">
          ...
          <p className="text-white/70 mt-2 max-w-xl">Projects and expertise across the UK.</p>
        </div>
          ...
          <div className="about-horizontal-scroll__inner">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="about-horizontal-card shrink-0 snap-center">
                ...
                <p className="text-white/60 text-sm">MEP design &amp; installation</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-lg text-black/80 leading-relaxed">
              Round-the-clock MEP support with rapid response times. When you need us most,
              we&apos;re here to keep your systems running and your operations secure.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="about-block about-block--black about-block--angle-top about-block--angle-bottom-alt min-h-screen flex flex-col justify-center px-6 lg:px-12 py-24 snap-start">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-2xl md:text-3xl lg:text-4xl text-white/90 leading-relaxed font-medium">
            &ldquo;We don&apos;t just install systems — we build long-term partnerships with our clients.&rdquo;
          </p>
      ...
      <section className="about-block about-block--white about-block--angle-top about-block--angle-bottom-alt min-h-screen flex items-center px-6 lg:px-12 py-24 snap-start">
        <div className="w-full max-w-7xl mx-auto">
          ...
          <p className="text-black/80 mt-8 max-w-2xl">
            Comprehensive warranties on all MEP work. Quality assurance and reliable service you can trust.
          </p>
        </div>
      </section>
      ...
      <section className="about-block about-block--black about-block--angle-top min-h-screen flex flex-col justify-center items-center px-6 py-24 snap-start">
        ...
        <p className="text-white/70 text-center max-w-xl mb-10">
          Ready to discuss your MEP requirements? We&apos;d love to hear from you.
        </p>
        <Link
          href="/#contact"
